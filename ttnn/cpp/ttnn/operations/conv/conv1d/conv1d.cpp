...
Result Conv1dOperation::invoke(
    ...
    const std::optional<const Conv1dSliceConfig>& dram_slice_config_,
    ...
    auto default_dram_slice_config = Conv1dSliceConfig{
        .slice_type = Conv1dSliceConfig::SliceType::L1_FULL
    };
    auto slice_config = dram_slice_config_.value_or(default_dram_slice_config);
