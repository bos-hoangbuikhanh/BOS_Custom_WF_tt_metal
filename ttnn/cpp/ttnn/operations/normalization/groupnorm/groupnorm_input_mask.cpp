...
ttnn::Tensor create_group_norm_input_mask_impl(
    ...
    std::vector<float> mask_vec(out_num_groups * out_tile_height * out_mask_width, is_negative_mask ? 1.0f : 0.0f);
    ...
    ttnn::Tensor mask = ttnn::Tensor::from_vector(mask_vec, tensor_spec, nullptr);
