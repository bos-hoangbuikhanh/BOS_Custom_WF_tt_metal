...
void RunTestLineMcast(BaseFabricFixture* fixture, const std::vector<McastRoutingInfo>& mcast_routing_info) {
    ...
    bool mcast_group_found = find_device_with_neighbor_in_multi_direction(
        fixture, sender_id, mcast_group, sender_phys_id, mcast_group_phys_ids_per_dir, mcast_hops);
    ...
    if (spine_hops) {
        if (mcast_group_phys_ids_per_dir.find(RoutingDirection::N) != mcast_group_phys_ids_per_dir.end()) {
            ...
            mcast_group_phys_ids.insert(
                mcast_group_phys_ids.end(),
                mcast_group_phys_ids_per_dir[RoutingDirection::N].begin(),
                mcast_group_phys_ids_per_dir[RoutingDirection::N].end());
            ...
            mcast_group_phys_ids.insert(
                mcast_group_phys_ids.end(),
                mcast_group_phys_ids_per_dir[RoutingDirection::S].begin(),
                mcast_group_phys_ids_per_dir[RoutingDirection::S].end());
        ...
        if (mcast_group_phys_ids_per_dir.find(RoutingDirection::E) != mcast_group_phys_ids_per_dir.end()) {
            ...
            mcast_group_phys_ids.insert(
                mcast_group_phys_ids.end(),
                mcast_group_phys_ids_per_dir[RoutingDirection::E].begin(),
                mcast_group_phys_ids_per_dir[RoutingDirection::E].end());
            ...
            mcast_group_phys_ids.insert(
                mcast_group_phys_ids.end(),
                mcast_group_phys_ids_per_dir[RoutingDirection::W].begin(),
                mcast_group_phys_ids_per_dir[RoutingDirection::W].end());
        }
    }
