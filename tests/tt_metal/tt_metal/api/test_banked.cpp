...
bool reader_cb_writer(
    ...
    if (banked_reader) {
        log_info(tt::LogTest, "banked_reader");
    ...
    if (banked_writer) {
        log_info(tt::LogTest, "banked_writer");
    ...
    log_info(tt::LogTest, "Input buffer: [address: {} B, size: {} B]", input_buffer->address(), input_buffer->size());
    log_info(
        tt::LogTest, "Output buffer: [address: {} B, size: {} B]", output_buffer->address(), output_buffer->size());
