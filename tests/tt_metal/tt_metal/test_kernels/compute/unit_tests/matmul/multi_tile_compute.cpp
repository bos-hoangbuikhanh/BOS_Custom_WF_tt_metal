...
inline void delay_sec2(float sec) {
    volatile long long counter = 0;
    volatile long long time_sec = 100000000 * sec;
    // The exact count value depends on CPU speed. Adjust as needed.
    for (long long i = 0; i < time_sec; ++i) {
        counter++;  // Prevent compiler optimization
    }
}
namespace NAMESPACE {
void MAIN {
