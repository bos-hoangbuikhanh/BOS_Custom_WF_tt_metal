...
// [BOS-ARCH-003] HW architecture
#define NOC_ADDR_LOCAL_BITS /*64*/ 40
...
// [BOS-ARCH-003] HW architecture
#define NOC_XY_PCIE_ENCODING(x, y) NOC_XY_ADDR(x, y, 0x2100000000)
...
// [BOS-ARCH-003] HW architecture
#define NOC_LOCAL_ADDR(addr) ((addr) & 0x0000001FFFFFFFFF)
