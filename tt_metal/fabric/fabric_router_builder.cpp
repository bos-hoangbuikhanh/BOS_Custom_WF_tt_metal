...
void FabricRouterBuilder::connect_to_downstream_router_over_noc(FabricRouterBuilder& other, uint32_t vc) {
...
uint32_t FabricRouterBuilder::get_downstream_sender_channel(
...
eth_chan_directions FabricRouterBuilder::get_direction() const { return erisc_builder_->get_direction(); }

size_t FabricRouterBuilder::get_noc_x() const { return erisc_builder_->get_noc_x(); }

size_t FabricRouterBuilder::get_noc_y() const { return erisc_builder_->get_noc_y(); }

size_t FabricRouterBuilder::get_configured_risc_count() const { return erisc_builder_->get_configured_risc_count(); }

FabricNodeId FabricRouterBuilder::get_local_fabric_node_id() const { return erisc_builder_->local_fabric_node_id; }

FabricNodeId FabricRouterBuilder::get_peer_fabric_node_id() const { return erisc_builder_->peer_fabric_node_id; }
