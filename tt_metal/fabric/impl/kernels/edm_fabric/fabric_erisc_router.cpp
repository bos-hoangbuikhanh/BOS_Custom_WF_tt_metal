...
FORCE_INLINE bool run_receiver_channel_step_impl(
    ...
    NamedProfiler<
        CodeProfilingTimerType::RECEIVER_CHANNEL_FORWARD,
...
void kernel_main() {
    ...
    *edm_status_ptr = tt::tt_fabric::EDMStatus::STARTED;
    ...
    auto local_receiver_channels = tt::tt_fabric::MultiPoolEthChannelBuffers<
        PACKET_HEADER_TYPE,
        channel_pools_args,
        RECEIVER_TO_POOL_TYPE,
        RECEIVER_TO_POOL_IDX>::make();
    ...
    local_receiver_channels.init<channel_pools_args>(channel_buffer_size, sizeof(PACKET_HEADER_TYPE));

    // initialize the remote receiver channel buffers
    remote_receiver_channels.init<eth_remote_channel_pools_args>(channel_buffer_size, sizeof(PACKET_HEADER_TYPE));

    // initialize the local sender channel worker interfaces
    local_sender_channels.init<channel_pools_args>(channel_buffer_size, sizeof(PACKET_HEADER_TYPE));
