...
public:
    ...
    FORCE_INLINE void set_should_dump(bool dump) { should_dump = dump; }
...
public:
    ...
    FORCE_INLINE void set_should_dump(bool dump) { timer.set_should_dump(dump); }

    FORCE_INLINE void open() { timer.open(); }

    FORCE_INLINE void close() { timer.close(); }
};
