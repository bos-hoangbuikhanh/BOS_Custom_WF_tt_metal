...
static_assert(
    ...
    "Special marker 2A not found. This implies some arguments were misaligned between host and device. Double check "
    "the "
    "CT args.");
...
using FWDED_SENDER_ELASTIC_CHANNELS_INFO = tt::tt_fabric::elastic_channels::
    RouterElasticChannelsCtArgs<ELASTIC_CHANNELS_CT_ARG_START_IDX, buffer_slot::size_bytes>;
