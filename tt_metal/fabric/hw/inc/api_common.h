...
enum class UnicastAtomicIncUpdateMask : uint32_t {
    ...
    Val = 1u << 1,
    Flush = 1u << 2,
    All = static_cast<uint32_t>(DstAddr) | static_cast<uint32_t>(Val) | static_cast<uint32_t>(Flush),
};
...
enum class UnicastFusedAtomicIncUpdateMask : uint32_t {
    ...
    Flush = 1u << 3,
    PayloadSize = 1u << 4,
    All = static_cast<uint32_t>(WriteDstAddr) | static_cast<uint32_t>(SemaphoreAddr) | static_cast<uint32_t>(Val) |
          static_cast<uint32_t>(Flush) | static_cast<uint32_t>(PayloadSize),
};
