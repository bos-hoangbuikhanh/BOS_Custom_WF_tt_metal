...
[[noreturn]] inline void tt_throw(const char* file, int line, const char* assert_type, const char* condition_str) {
...
inline void tt_assert(const char* file, int line, const char* assert_type, bool condition, const char* condition_str) {
    if (not condition) {
