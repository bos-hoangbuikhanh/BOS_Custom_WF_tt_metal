...
from ..tt.ttnn_functional_upsample_nearest_2d import upsample_nearest2d
...
class upsample2d:
    ...
    def __call__(self, input, in_channels, out_channels):
        # Reshaping a sharded tensor causes "Buffer::set_page_size is unsupported for BufferDistributionSpec!" error.
