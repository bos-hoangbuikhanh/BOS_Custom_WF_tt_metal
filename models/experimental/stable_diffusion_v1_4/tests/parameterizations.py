...
CROSS_DOWN_BLOCKS_HIDDEN_STATES_INFO = (
    ([2, 320, 64, 64], ttnn.TensorMemoryLayout.BLOCK_SHARDED, (4, 3), (2048, 64)),
    ([2, 640, 32, 32], ttnn.TensorMemoryLayout.BLOCK_SHARDED, (4, 3), (512, 128)),
    ([2, 1280, 16, 16], ttnn.TensorMemoryLayout.BLOCK_SHARDED, (4, 3), (128, 256)),
)

DOWN_MID_UP_BLOCKS_HIDDEN_STATES_INFO = ([2, 1280, 8, 8], ttnn.TensorMemoryLayout.BLOCK_SHARDED, (4, 3), (32, 256))
