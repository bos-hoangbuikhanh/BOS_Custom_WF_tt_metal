...
@pytest.mark.parametrize(
    ...
    [
        (0, [2, 320, 64, 64], ttnn.TensorMemoryLayout.HEIGHT_SHARDED, (3, 3), (512, 320), 320),
        (1, [2, 320, 32, 32], ttnn.TensorMemoryLayout.BLOCK_SHARDED, (4, 3), (512, 64), 640),
        (2, [2, 640, 16, 16], ttnn.TensorMemoryLayout.BLOCK_SHARDED, (4, 3), (128, 128), 1280),
    ],
)
