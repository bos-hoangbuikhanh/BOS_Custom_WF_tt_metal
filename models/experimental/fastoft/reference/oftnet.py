...
class OftNet(nn.Module):
    def __init__(
        ...
        self.lat8 = nn.Conv2d(128, 256, 1, dtype=dtype) if (oft_mode == OftMode.ORIGINAL or oft_mode == OftMode.OFT8)  else None
        self.lat16 = nn.Conv2d(256, 256, 1, dtype=dtype) if (oft_mode == OftMode.ORIGINAL or oft_mode == OftMode.OFT16)  else None
        self.lat32 = nn.Conv2d(512, 256, 1, dtype=dtype) if (oft_mode == OftMode.ORIGINAL or oft_mode == OftMode.OFT32)  else None
        ...
        self.oft8 = OFT(input_channels, output_channels, grid_res, grid_height, 1 / 8.0, dtype=dtype) if (oft_mode == OftMode.ORIGINAL or oft_mode == OftMode.OFT8)  else None
        self.oft16 = OFT(input_channels, output_channels, grid_res, grid_height, 1 / 16.0, dtype=dtype) if (oft_mode == OftMode.ORIGINAL or oft_mode == OftMode.OFT16)  else None
        self.oft32 = OFT(input_channels, output_channels, grid_res, grid_height, 1 / 32.0, dtype=dtype) if (oft_mode == OftMode.ORIGINAL or oft_mode == OftMode.OFT32)  else None
