...
class ResNetFeatures(nn.Module):
    def __init__(self, block, layers, dtype, frontend_mode=FrontendMode.ORIGINAL, num_classes=1000, zero_init_residual=False, return_intermediates=False):
        ...
        ) if frontend_mode == FrontendMode.ORIGINAL else None
