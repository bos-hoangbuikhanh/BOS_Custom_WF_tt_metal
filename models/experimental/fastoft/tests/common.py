...
def load_checkpoint(ref_model, model_location_generator=None, oft_mode=None):
    ...
    if checkpoints_path is not None and os.path.isfile(checkpoints_path):
        ...
        ref_model.load_state_dict(state_dict, strict=True)  # to be able to test fastOFT with original weights
