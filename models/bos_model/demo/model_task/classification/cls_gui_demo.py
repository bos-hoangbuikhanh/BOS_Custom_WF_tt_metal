...
def classification_runner(device_id, batch_size, num_iter=1, **kwargs):
    ...
    for nt in range(num_iter):
        ...
        for it, batch in enumerate(data_loader):
            ...
            model.profiler.end(f"inference_batch")
            ...
            # FPS
            batch_inference_time = model.profiler.get(f"inference_batch") / num_measurement_iterations
...
if __name__ == "__main__":
    ...
    classification_runner(args.device_id, args.batch, args.n, **cfg)
