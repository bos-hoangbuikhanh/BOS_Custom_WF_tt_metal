...
import ttnn
from models.bos_model.yolo.yolov10s.tt.common import Conv
...
class TtnnAttention:
    ...
    def __call__(self, input_tensor):
        ...
        qkv = ttnn.reshape(qkv, (B, 4, 128, qkv.shape[3]))
        ...
        attn = ttnn.reshape(attn, (1, 256, 1, attn.shape[-1]))
        attn = ttnn.permute(attn, (0, 2, 3, 1))

        v = ttnn.reshape(v, (1, 256, 1, v.shape[-1]))
