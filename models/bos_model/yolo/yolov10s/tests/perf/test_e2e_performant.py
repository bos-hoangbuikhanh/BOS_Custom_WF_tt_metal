...
import ttnn
from models.bos_model.yolo.yolov10s.common import YOLOV10_L1_SMALL_SIZE
...
def run_yolov10s_inference(
    ...
    pipeline = create_pipeline_from_config(
        ...
        model=YoloV10sPipelineRunner(test_infra),
        device=device,
