...
import ttnn
from models.bos_model.yolo.yolov11n.common import load_torch_model
from models.bos_model.yolo.yolov11n.tt import ttnn_yolov11
from models.bos_model.yolo.yolov11n.tt.model_preprocessing import create_yolov11_model_parameters
...
class YOLOv11PerformanceRunnerInfra:
    def __init__(
        ...
        self.torch_input_tensor = (
            torch.randn((batch_size * self.num_devices, 3, 320, 320), dtype=torch.float32)
