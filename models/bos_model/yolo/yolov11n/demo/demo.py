...
from models.bos_model.yolo.yolov11n.common import YOLOV11_L1_SMALL_SIZE, load_torch_model
from models.bos_model.yolo.yolov11n.reference import yolov11
from models.bos_model.yolo.yolov11n.runner.performant_runner import YOLOv11PerformantRunner
...
def run_yolov11n_demo(
    ...
    save_dir = "models/bos_model/yolo/yolov11n/demo/outputs"
...
@pytest.mark.parametrize(
    ...
    [
        (
            "models/bos_model/yolo/yolov11n/demo/images",
            1,
        ),
    ],
)
