...
import ttnn
from models.bos_model.yolo.yolov12x.common import load_torch_model
from models.bos_model.yolo.yolov12x.tt.model_preprocessing import create_yolov12x_model_parameters
from models.bos_model.yolo.yolov12x.tt.yolov12x import YoloV12x
...
class YOLOv12xPerformanceRunnerInfra:
    def __init__(
        ...
        self.torch_input_tensor = (
            torch.randn((self.batch_size * self.num_devices, 3, 320, 320), dtype=torch.float32)
            if self.torch_input_tensor is None
            else self.torch_input_tensor
        )

        self.torch_input_params = torch.randn((batch_size, 3, 320, 320), dtype=torch.float32)
