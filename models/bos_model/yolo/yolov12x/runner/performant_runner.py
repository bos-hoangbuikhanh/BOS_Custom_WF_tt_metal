...
import ttnn
from models.bos_model.yolo.yolov12x.runner.performant_runner_infra import YOLOv12xPerformanceRunnerInfra
from tests.ttnn.utils_for_testing import assert_with_pcc


class YOLOv12xPerformantRunner:
    def __init__(
        self,
        device,
        device_batch_size=1,
    ...
    def _execute_yolov12x_trace_2cqs_inference(self, tt_inputs_host=None):
