...
from models.bos_model.yolo.yolov12x.reference import yolov12x
from models.bos_model.yolo.yolov12x.tt.model_preprocessing import (
...
def test_yolov12x(use_pretrained_weight, device, reset_seeds, model_location_generator):
    ...
    assert_with_pcc(torch_output[0], ttnn_output, 0.98)
