...
from models.bos_model.yolo.yolov12x.common import YOLOV12_L1_SMALL_SIZE, load_torch_model
from models.bos_model.yolo.yolov12x.runner.performant_runner import YOLOv12xPerformantRunner
...
def run_yolov12x_demo(
    ...
    save_dir = "models/bos_model/yolo/yolov12x/demo/outputs"
...
@pytest.mark.parametrize(
    ...
    [
        (
            "models/bos_model/yolo/yolov12x/demo/images/bus.jpg",
            1,
        ),
    ],
)
