...
import ttnn
from models.bos_model.yolo.yolov12x.reference.yolov12x import Conv, YoloV12x
from models.bos_model.yolo.yolov12x.tt.common import get_mesh_mappers
...
def create_yolov12x_input_tensors(device, batch_size=1, input_channels=3, input_height=320, input_width=320):
...
def create_yolov12x_input_tensors_submodules(
    device, batch_size=1, input_channels=3, input_height=320, input_width=320, weights_mesh_mapper=None
):
    torch_input_tensor = torch.randn(batch_size, input_channels, input_height, input_width)
