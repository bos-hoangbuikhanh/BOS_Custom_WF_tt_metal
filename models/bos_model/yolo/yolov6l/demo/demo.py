...
import ttnn
from models.bos_model.yolo.common.demo_utils import (
    LoadImages,
    get_mesh_mappers,
...
from models.bos_model.yolo.yolov6l.demo.demo_utils import postprocess
from models.bos_model.yolo.yolov6l.runner.performant_runner import YOLOv6lPerformantRunner
...
def run_yolov6l_demo(
    ...
    save_dir = "models/bos_model/yolo/yolov6l/demo/outputs"
...
@pytest.mark.parametrize(
    ...
    [
        (
            "models/bos_model/yolo/yolov6l/demo/images",
            1,
        ),
    ],
)
