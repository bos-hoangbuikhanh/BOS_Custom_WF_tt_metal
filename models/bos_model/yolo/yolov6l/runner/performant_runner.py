...
import ttnn
from models.bos_model.yolo.yolov6l.runner.performant_runner_infra import YOLOv6lPerformanceRunnerInfra


class YOLOv6lPerformantRunner:
    def __init__(
        self,
        device,
        device_batch_size=1,
        ...
        self.runner_infra = YOLOv6lPerformanceRunnerInfra(
            device,
            device_batch_size,
            act_dtype,
            weight_dtype,
        ...
        self._capture_yolov6l_trace_2cqs()

    def _capture_yolov6l_trace_2cqs(self):
    ...
    def _execute_yolov6l_trace_2cqs_inference(self, tt_inputs_host=None):
    ...
    def run(self, torch_input_tensor, check_pcc=False):
        ...
        output = self._execute_yolov6l_trace_2cqs_inference(tt_inputs_host)
