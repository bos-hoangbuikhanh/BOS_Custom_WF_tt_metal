...
import ttnn
from models.bos_model.yolo.yolov6l.common import YOLOV6L_L1_SMALL_SIZE, load_torch_model
from models.bos_model.yolo.yolov6l.tt.model_preprocessing import create_yolov6l_model_parameters
from models.bos_model.yolo.yolov6l.tt.ttnn_bifusion import TtBiFusion
...
def test_yolov6l_bifusion(device, reset_seeds, model_location_generator):
    ...
    torch_input_0 = torch.randn(1, 256, 10, 10)
    torch_input_1 = torch.randn(1, 512, 20, 20)
    torch_input_2 = torch.randn(1, 256, 40, 40)
    ...
    input_tensor_0 = torch_input_0.reshape(1, 256, 1, 100)
    ...
    input_tensor_1 = torch_input_1.reshape(1, 512, 1, 400)
    ...
    input_tensor_2 = torch_input_2.reshape(1, 256, 1, 1600)
