...
from models.bos_model.yolo.yolov6l.tt.model_preprocessing import create_yolov6l_model_parameters_detect
from models.bos_model.yolo.yolov6l.tt.ttnn_detect import TtDetect
...
def test_detect(device, reset_seeds, model_location_generator):
    ...
    torch_input_0 = torch.randn(1, 128, 40, 40)
    torch_input_1 = torch.randn(1, 256, 20, 20)
    torch_input_2 = torch.randn(1, 512, 10, 10)
