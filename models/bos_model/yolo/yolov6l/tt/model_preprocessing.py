...
import ttnn
from models.bos_model.yolo.yolov6l.reference.yolov6l import Model
from models.bos_model.yolo.yolov6l.tt.common import get_mesh_mappers

sys.path.append("models/bos_model/yolo/yolov6l/reference/")
...
def create_yolov6l_model_parameters(model: Model, torch_input: torch.Tensor, device, res=(320, 320)):
    ...
    ones_tensor = torch.ones((1, 1, 2100), dtype=torch.float32)
