...
def qwen25_runner(device_id, batch_size, num_iters, **kwargs):
    """
    ...
    if "model" in kwargs:
        ...
        os.environ["HF_MODEL"] = "Qwen/Qwen2.5-VL-7B-Instruct"
    ...
    output_dir = kwargs.get("output_dir", "models/bos_model/qwen25_vl/demo/outputs")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="HF_MODEL name (default: Qwen/Qwen2.5-VL-7B-Instruct)",
    )
    ...
    if args.model is not None:
        ...
        args.model = os.environ["HF_MODEL"] = "Qwen/Qwen2.5-VL-7B-Instruct"
    ...
    cfg = {
        ...
        "output_dir": "models/bos_model/qwen25_vl/demo/outputs",  # Optional save path
    }
    qwen25_runner(device_id=args.device_id, batch_size=args.batch_size, num_iters=args.num_iters, **cfg)
