...
import ttnn
from models.bos_model.qwen25_vl.tt.vision.qwen_image_block import TtQwen2_5_VLVisionBlock
from models.bos_model.qwen25_vl.tt.vision.qwen_image_patch_embed import TTQwen2_5_VisionPatchEmbed
from models.bos_model.qwen25_vl.tt.vision.qwen_patch_merger import TTQwen2_5_VLPatchMerger
from models.bos_model.qwen25_vl.tt.vision.qwen_rope import (
    Qwen2_5_VisionRotaryEmbedding,
    TTQwen2_5_VisionRotaryEmbedding,
)
...
class TtQwen2_5_VisionTransformerPretrainedModel(LightweightModule):
    ...
    def forward(self, hidden_states, grid_thw):
        ...
        for layer_num, blk in enumerate(tqdm(self.blocks, desc="32 x Qwen2_5_VLVisionBlock")):
