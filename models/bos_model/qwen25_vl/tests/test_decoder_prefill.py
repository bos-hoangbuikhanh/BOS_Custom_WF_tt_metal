...
import ttnn
from models.bos_model.qwen25_vl.tests.test_utils import get_ref_model_dype
from models.bos_model.qwen25_vl.tt.common import PagedAttentionConfig, get_rot_transformation_mat
...
from models.bos_model.qwen25_vl.tt.rope import get_rot_mats
...
def test_decoder_inference(
    ...
    if "AWQ" in model_args.model_name:
        pytest.skip("Submodule tests are not configured for AWQ models — test the demo directly.")
