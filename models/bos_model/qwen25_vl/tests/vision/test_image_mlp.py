""""Test for Qwen 2.5 VL Vision MLP"""
...
from models.bos_model.qwen25_vl.tt.vision.qwen_image_mlp import QwenTTVisionMLP
...
def test_mlp_inference(batch, num_chunks, mesh_device, reset_seeds):
    ...
    first_layer_prefix = "visual.blocks.0.feed_forward."
    partial_state_dict = {
