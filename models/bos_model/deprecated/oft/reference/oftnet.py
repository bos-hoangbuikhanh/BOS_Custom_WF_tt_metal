...
from models.bos_model.oft.reference import resnet
from models.bos_model.oft.reference.oft import OFT
...
class OftNet(nn.Module):
    ...
    def forward(self, image, calib, grid):
        ...
        # torch.save(ortho, "models/bos_model/oft/debug/torch_dumps/ortho.pt")
