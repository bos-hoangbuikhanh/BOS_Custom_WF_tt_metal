...
class TtnnResnet34:
    def __init__(self, conv_args, conv_pth, device):
        ...
        self.conv1 = TtnnUFLDV2Conv2D(
            ...
            # shard_layout=ttnn.TensorMemoryLayout.WIDTH_SHARDED, # giving OOM issue
            shard_layout=None,
        )
    ...
    def __call__(
        ...
        batch_size=1,
        min_channels=16,
        #  shard_height_for_maxcores=16128
        shard_height_for_maxcores=16000,
    ):
        n, c, h, w = input.shape
        channel_padding_needed = min_channels - c
        input = ttnn.sharded_to_interleaved(input, memory_config=ttnn.DRAM_MEMORY_CONFIG)
