...
import ttnn
from models.bos_model.ufld_v2.reference.ufld_v2_model import BasicBlock, TuSimple34
from models.bos_model.ufld_v2.tt.model_preprocessing import UFLD_V2_L1_SMALL_SIZE
from models.bos_model.ufld_v2.tt.ttnn_basic_block import TtnnBasicBlock
...
def test_ufld_v2_model(device, batch_size, input_channels, height, width, use_pretrained_weight, min_channels=8):
    ...
    if use_pretrained_weight:
        ...
        if not os.path.exists(weights_path):
            os.system("bash models/bos_model/ufld_v2/weights_download.sh")
