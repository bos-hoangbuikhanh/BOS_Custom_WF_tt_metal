...
import ttnn
from models.bos_model.qwen3_vl.tt.common import copy_host_to_device
from models.bos_model.qwen3_vl.tt.decoder import TransformerBlock
from models.bos_model.qwen3_vl.tt.distributed_norm import DistributedNorm
from models.bos_model.qwen3_vl.tt.embedding import Embedding
from models.bos_model.qwen3_vl.tt.lm_head import LMHead
from models.bos_model.qwen3_vl.tt.model_config import TensorGroup
from models.bos_model.qwen3_vl.tt.rmsnorm import RMSNorm
...
class Transformer(LightweightModule):
    def __init__(
        ...
        self.simplified_rms = True if self.args.base_model_name in ["Qwen2.5-VL-7B"] else False
