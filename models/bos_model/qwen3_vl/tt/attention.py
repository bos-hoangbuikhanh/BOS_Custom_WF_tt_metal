...
import ttnn
from models.bos_model.qwen3_vl.tt.ccl import tt_all_gather, tt_all_reduce
from models.bos_model.qwen3_vl.tt.model_config import OpGroup, TensorGroup
from models.bos_model.qwen3_vl.tt.rmsnorm import RMSNorm as RMSNorm
...
class Attention(LightweightModule):
    def __init__(
        ...
        #     k=configuration.dim, n=configuration.hidden_dim // configuration.num_devices)
    ...
    def forward_decode(
        ...
        xqkv_fused_sharded = ttnn.linear(
            ...
            # program_config=self.model_config["XQKV_DECODE_PROGCFG"], #FIXME
