...
import ttnn
from models.bos_model.qwen3_vl.tt.common import PagedAttentionConfig, get_rot_transformation_mat
...
from models.bos_model.qwen3_vl.tt.rope import get_rot_mats
...
def test_decoder_inference(
    ...
    for i in range(generation_length):
        ...
        tt_output_torch = (
            tt_out[:, 0:1, :, : model_args.dim].view(batch_size, max_seq_len, -1).squeeze(0)
        )  # [ batch_size, seq, hidden_dim]
