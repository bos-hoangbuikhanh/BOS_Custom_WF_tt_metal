...
```
<!--
// The testing scenairos will be avaliable in next release 
...
Located in `models/bos_model/oft/tests/pcc/`, these tests validate the accuracy of TTNN implementations against PyTorch reference models using PCC metrics.
...
**Usage:**
```bash
TT_METAL_CORE_GRID_OVERRIDE_TODEPRECATE="4,3" pytest models/bos_model/oft/tests/pcc/test_basicblock.py
```
...
**Usage:**
```bash
TT_METAL_CORE_GRID_OVERRIDE_TODEPRECATE="4,3" pytest models/bos_model/oft/tests/pcc/test_encoder.py
```
...
**Usage:**
```bash
TT_METAL_CORE_GRID_OVERRIDE_TODEPRECATE="4,3" pytest models/bos_model/oft/tests/pcc/test_oft.py
```
...
**Usage:**
```bash
TT_METAL_CORE_GRID_OVERRIDE_TODEPRECATE="4,3" pytest models/bos_model/oft/tests/pcc/test_oftnet.py
```
...
**Usage:**
```bash
TT_METAL_CORE_GRID_OVERRIDE_TODEPRECATE="4,3" pytest models/bos_model/oft/tests/pcc/test_resnet.py
```
...
```bash
# Run all PCC tests
TT_METAL_CORE_GRID_OVERRIDE_TODEPRECATE="4,3" pytest models/bos_model/oft/tests/pcc/
```
...
TT_METAL_CORE_GRID_OVERRIDE_TODEPRECATE="4,3" pytest models/bos_model/oft/tests/test_device_perf_oft.py::test_device_perf_oft -k device_perf_oft_oftnet
```
```bash
# Run decoder performance test
TT_METAL_CORE_GRID_OVERRIDE_TODEPRECATE="4,3" pytest models/bos_model/oft/tests/test_device_perf_oft.py::test_device_perf_oft -k device_perf_oft_decoder
```
```bash
# Run full oft performance test
TT_METAL_CORE_GRID_OVERRIDE_TODEPRECATE="4,3" pytest models/bos_model/oft/tests/test_device_perf_oft.py::test_device_perf_oft -k device_perf_oft_full
```
```bash
# Run all performance tests
TT_METAL_CORE_GRID_OVERRIDE_TODEPRECATE="4,3" pytest models/bos_model/oft/tests/test_device_perf_oft.py::test_device_perf_oft
```
-->
