...
from models.bos_model.oft.tests.common import GRID_RES, GRID_SIZE, GRID_HEIGHT, Y_OFFSET, H_PADDED, W_PADDED
from models.bos_model.oft.tests.common import load_checkpoint

from models.bos_model.oft.reference.utils import make_grid, load_calib, load_image
from models.bos_model.oft.reference.utils import get_abs_and_relative_error

from tests.ttnn.utils_for_testing import check_with_pcc
from models.bos_model.oft.tt.model_preprocessing import create_OFT_model_parameters
...
@pytest.mark.parametrize(
    ...
    # fmt: off
    [
       ( torch.bfloat16, 0.862, 0.888, 0.998, 0.894),
...
def test_oftnet(
    ...
    if SAVE_OUTPUTS:
        ...
        test_config = f"{model_dtype}_device_oft"
