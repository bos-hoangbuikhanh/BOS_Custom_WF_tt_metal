...
def run_ufldv2_e2e(
    ...
    width=800,
    channels=3,
    input_memory_layout="dram_sharded",
    use_2cq=True,
    model_type="tusimple",
):
    ...
    for _ in range(num_iter):
        ...
        output_tensors.append(ttnn.from_device(output_tensor, blocking=False))  # to measure H2D
...
def test_ufldv2_e2e_performant(device, batch_size, model_location_generator, input_memory_layout):
    run_ufldv2_e2e(device, batch_size, model_location_generator, input_memory_layout=input_memory_layout)
...
def test_ufldv2_e2e_performant_culane(device, batch_size, model_location_generator, input_memory_layout):
    run_ufldv2_e2e(
        device,
        batch_size,
        model_location_generator,
