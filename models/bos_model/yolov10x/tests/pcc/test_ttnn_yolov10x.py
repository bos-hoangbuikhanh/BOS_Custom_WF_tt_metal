...
import ttnn
from models.bos_model.yolov10x.common import YOLOV10_L1_SMALL_SIZE, load_torch_model
from models.bos_model.yolov10x.reference.yolov10x import YOLOv10
from models.bos_model.yolov10x.tt.attention import TtnnAttention
from models.bos_model.yolov10x.tt.bottleneck import TtnnBottleNeck
from models.bos_model.yolov10x.tt.c2f import TtnnC2f
from models.bos_model.yolov10x.tt.cib import TtnnCIB
from models.bos_model.yolov10x.tt.model_preprocessing import (
...
from models.bos_model.yolov10x.tt.psa import TtnnPSA
from models.bos_model.yolov10x.tt.scdown import TtnnSCDown
from models.bos_model.yolov10x.tt.sppf import TtnnSPPF
from models.bos_model.yolov10x.tt.v10detect import TtnnV10Detect
from models.bos_model.yolov10x.tt.yolov10x import TtnnYolov10
...
@pytest.mark.parametrize(
    ...
    [
        (2, (1, 160, 80, 80), 3, True, ttnn.DRAM_MEMORY_CONFIG),
        (4, (1, 320, 40, 40), 6, True, ttnn.L1_MEMORY_CONFIG),
        (16, (1, 960, 40, 40), 3, False, ttnn.L1_MEMORY_CONFIG),
    ],
)
@pytest.mark.parametrize("device_params", [{"l1_small_size": YOLOV10_L1_SMALL_SIZE}], indirect=True)
...
@pytest.mark.parametrize(
    ...
    [
        (23, ([1, 320, 40, 40], [1, 640, 20, 20], [1, 640, 10, 10]), 3, True),
    ],
)
@pytest.mark.parametrize("device_params", [{"l1_small_size": YOLOV10_L1_SMALL_SIZE}], indirect=True)
...
@pytest.mark.parametrize("device_params", [{"l1_small_size": YOLOV10_L1_SMALL_SIZE}], indirect=True)
def test_yolov10x_model(use_pretrained_weights, device, reset_seeds, model_location_generator, res):
    torch_input, ttnn_input = create_yolov10x_input_tensors(
        device, input_height=res[0], input_width=res[1], use_sharding=False
    )
    state_dict = None
    ...
    torch_model.load_state_dict(new_state_dict)
    torch_model.eval()
    parameters = create_yolov10x_model_parameters(torch_model, torch_input, device, inp_h=res[0], inp_w=res[1])
