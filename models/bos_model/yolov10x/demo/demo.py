...
from models.bos_model.yolov10x.demo.demo_utils import postprocess
...
def run_inference_and_save(
    ...
    if model_type == "torch_model":
        ...
        pipeline = create_pipeline_from_config(
            config,
            YoloV10xPipelineRunner(test_infra),
            device,
...
def run_yolov10x_demo(
    ...
    save_dir = "models/bos_model/yolov10x/demo/outputs"
...
@pytest.mark.parametrize(
    ...
    [
        (
            "models/bos_model/yolov10x/demo/images/",
            1,
        ),
    ],
)
