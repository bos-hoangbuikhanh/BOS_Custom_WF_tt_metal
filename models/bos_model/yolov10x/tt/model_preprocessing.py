...
import ttnn
from models.bos_model.yolov10x.reference.yolov10x import Conv, YOLOv10
...
def create_yolov10x_model_parameters(model: YOLOv10, input_tensor: torch.Tensor, device, inp_h=320, inp_w=320):
