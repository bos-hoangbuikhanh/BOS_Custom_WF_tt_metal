...
from models.bos_model.panoptic_deeplab.tt.common import reshape_flattened_conv_output
from models.bos_model.panoptic_deeplab.tt.tt_aspp import TtASPP
from models.bos_model.panoptic_deeplab.tt.tt_upsample import BilinearUpsampleMatmulTTNN as TtBilinearUpsample
...
class TtDeepLabV3PlusHead(LightweightModule):
    ...
    def layers(self, features: Dict[str, ttnn.Tensor]) -> ttnn.Tensor:
        ...
        for i, f_key in enumerate(feature_keys[1:]):
            ...
            if y.dtype != ttnn.bfloat16:  # A0 requires typecast bfloat8b tile to row_major
                y = ttnn.typecast(y, dtype=ttnn.bfloat16)
