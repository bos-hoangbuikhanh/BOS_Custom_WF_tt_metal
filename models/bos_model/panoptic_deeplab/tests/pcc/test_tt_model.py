...
from models.bos_model.panoptic_deeplab.tests.pcc.common import check_ttnn_output
...
@pytest.mark.parametrize("model_category", [DEEPLAB_V3_PLUS])
...
def test_model_panoptic_deeplab(device, model_category, model_location_generator):
    ...
    with torch.no_grad():
        pytorch_semantic, pytorch_center, pytorch_offset, _ = pytorch_model.forward(pytorch_input.to(torch.float32))
