...
class ModelOptimizations:
    def __init__(
        self,
        conv_output_dtype=ttnn.float32,
        ...
        self.conv_configs["HS_ABH_64_TILE"] = ttnn.Conv2dConfig(
            weights_dtype=conv_w_dtype,
        ...
        self.conv_configs["HS_ABH_32_TILE_REALLOC"] = ttnn.Conv2dConfig(
            weights_dtype=conv_w_dtype,
            shard_layout=ttnn.TensorMemoryLayout.HEIGHT_SHARDED,
            deallocate_activation=False,
        ...
        self.conv_configs["HS_ABH_64_TILE_FUSED"] = ttnn.Conv2dConfig(
            weights_dtype=conv_w_dtype,
            shard_layout=ttnn.TensorMemoryLayout.HEIGHT_SHARDED,
            deallocate_activation=False,
            reallocate_halo_output=False,
        ...
        self.conv_configs["HS_ABH_128_TILE_FUSED"] = ttnn.Conv2dConfig(
            weights_dtype=conv_w_dtype,
            shard_layout=ttnn.TensorMemoryLayout.HEIGHT_SHARDED,
            deallocate_activation=False,
            enable_act_double_buffer=False,
        ...
        self.conv_configs["HS_ABH_64_TILE_DEALLOC"] = ttnn.Conv2dConfig(
            weights_dtype=conv_w_dtype,
            shard_layout=ttnn.TensorMemoryLayout.HEIGHT_SHARDED,
        ...
        self.conv_configs["HS_ABH_64_RM_FUSED"] = ttnn.Conv2dConfig(
            weights_dtype=conv_w_dtype,
            shard_layout=ttnn.TensorMemoryLayout.HEIGHT_SHARDED,
            deallocate_activation=False,  # cannot deallocate if in dram
            enable_act_double_buffer=False,
        ...
        self.compute_configs["DEFAULT_CONV_COMPUTE_CONFIG"] = ttnn.WormholeComputeKernelConfig(
            math_fidelity=ttnn.MathFidelity.LoFi,  # Should be LoFi on N1
    ...
    def get_conv_config(self, conv_path):
        ...
        if conv_path == "frontend.conv1":
            return (
                self.conv_configs["HS_ABH_128_TILE_FUSED"],
        ...
        if conv_path == "frontend.layer1.0.conv1":
            return (
                self.conv_configs["HS_ABH_64_TILE_FUSED"],  # has residual in DRAM
        ...
        if conv_path == "frontend.layer1.0.conv2":
            return (
                self.conv_configs["HS_ABH_64_TILE_DEALLOC"],
                self.conv_slice_configs["DEFAULT"],
                self.compute_configs["DEFAULT_CONV_COMPUTE_CONFIG"],
                ttnn.bfloat16,
            )
        ...
        if conv_path == "topdown.0.conv1":
            return (
                self.conv_configs["HS_ABH_64_TILE_FUSED"],
                self.conv_slice_configs["DEFAULT"],
                self.compute_configs["DEFAULT_CONV_COMPUTE_CONFIG"],
                ttnn.bfloat16,
            )
        if conv_path == "topdown.0.conv2":
            return (
                self.conv_configs["HS_ABH_32_TILE_REALLOC"],
                self.conv_slice_configs["DEFAULT"],
                self.compute_configs["DEFAULT_CONV_COMPUTE_CONFIG"],
                ttnn.bfloat16,
            )
