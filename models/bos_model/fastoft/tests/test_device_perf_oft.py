...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            57_090_740,  # N1:57_090_740, BH:27_999_174
            "oft_oftnet",
            "oft_oftnet",
            1,
            1,
        ...
        (
            ...
            3_003_196,  # N1:3_003_196, BH:4_569_515
            "oft_decoder",
            "oft_decoder",
            1,
            1,
        ...
        (
            f"pytest {os.path.abspath(os.path.join(os.path.dirname(__file__), '../demo/demo.py'))}::test_demo_inference",
            60_585_372,  # N1:60_585_372, BH:30_743_019
            "oft_full_oft8",
            "oft_full_oft8",
            1,
            1,
