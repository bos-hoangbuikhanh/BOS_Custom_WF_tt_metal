...
@pytest.mark.parametrize(
    ...
    [
        ...
        ((1, 256, 48, 160), 128, 0.5, 4, 1 / 8, torch.float32,   True, 0.999, 0.981, 44),
        ((1, 256, 48, 160), 128, 0.5, 4, 1 / 8, torch.bfloat16,  True, 0.999, 0.374, 44),
        # # feats16 {float32,bfloat16} x {use_precomputed_grid, no_use_precomputed_grid}
        ((1, 256, 24, 80), 128, 0.5, 4, 1 / 16, torch.float32,   True, 0.999, 0.996, 44),
        ...
        ((1, 256, 12, 40), 128, 0.5, 4, 1 / 32, torch.float32,   True, 0.999, 0.998, 44),
...
def test_oft_forward(
    ...
    ref_oft = ReferenceOFT(
        input_channels, output_channels, cell_size, grid_height, scale=scale, dtype=torch_model_dtype
    )
