...
from ...reference.utils import get_abs_and_relative_error, load_calib, load_image, make_grid
from ...tests.common import GRID_HEIGHT, GRID_RES, GRID_SIZE, H_PADDED, W_PADDED, Y_OFFSET, load_checkpoint
...
@pytest.mark.parametrize(
    ...
    # fmt: off
    [
       ( torch.float32,     OftMode.OFT8, 0.990, 0.917, 0.999, 0.951),
    ],
    # fmt: on
    ids=[
        "fp32_oft8",
