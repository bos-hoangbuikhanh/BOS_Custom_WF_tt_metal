...
import ttnn
from models.bos_model.yolov4.common import YOLOV4_L1_SMALL_SIZE, get_model_result
from models.bos_model.yolov4.demo.post_processing import plot_boxes_cv2, post_processing
from models.bos_model.yolov4.runner.performant_runner_infra import YOLOv4PerformanceRunnerInfra
from models.bos_model.yolov4.runner.pipeline_runner import YoloV4PipelineRunner
...
def run_yolov4(
    ...
    output_dir = "models/bos_model/yolov4/demo/outputs/"
...
@pytest.mark.parametrize(
    "input_loc",
    [
        "models/bos_model/yolov4/resources",
    ],
)
@pytest.mark.parametrize(
