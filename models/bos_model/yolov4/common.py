...
import ttnn
from models.bos_model.yolov4.reference.downsample1 import DownSample1
from models.bos_model.yolov4.reference.downsample2 import DownSample2
from models.bos_model.yolov4.reference.downsample3 import DownSample3
from models.bos_model.yolov4.reference.downsample4 import DownSample4
from models.bos_model.yolov4.reference.downsample5 import DownSample5
from models.bos_model.yolov4.reference.head import Head
from models.bos_model.yolov4.reference.neck import Neck
from models.bos_model.yolov4.reference.yolov4 import Yolov4
...
def load_torch_model(model_location_generator, module=None):
    ...
    if model_path == "models":
        if not os.path.exists("models/bos_model/yolov4/tests/pcc/yolov4.pth"):  # check if yolov4.th is availble
            os.system(
                "models/bos_model/yolov4/tests/pcc/yolov4_weights_download.sh"
            )  # execute the yolov4_weights_download.sh file
        weights_pth = "models/bos_model/yolov4/tests/pcc/yolov4.pth"
    else:
