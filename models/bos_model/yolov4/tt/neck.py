...
import ttnn
from models.bos_model.yolov4.common import create_conv2d_config
from models.common.utility_functions import is_blackhole
from models.tt_cnn.tt.builder import TtConv2d


def determine_num_cores_for_upsample(nhw: int, width: int, max_cores=20) -> int:
...
def get_core_grid_from_num_cores(num_cores: int, grid_rows: int = 5, grid_cols: int = 4):
