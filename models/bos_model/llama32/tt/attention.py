...
import ttnn
from models.bos_model.llama32.tt.ccl import tt_all_gather, tt_all_reduce
from models.bos_model.llama32.tt.model_config import OpGroup, TensorGroup
...
class Attention(LightweightModule):
    ...
    def forward_decode(
        ...
        # This is unoptimized version of nlp_concat_heads_decode
        # Above implementation requires cores = n_local_heads  i.e. 32 cores (available 20 cores)

        # Input -> [seq_len=1, B=32, num_heads, head_dim]
        # Ouptput -> [seq_len=1, 1, B=32, num_heads * head_dim]
    ...
    def forward_prefill(
        ...
        output_11SH = ttnn.linear(
            ...
            memory_config=ttnn.DRAM_MEMORY_CONFIG,
            # program_config=self.model_config["WO_PREFILL_PROGCFG"](seq_len), # FIXME
        )
