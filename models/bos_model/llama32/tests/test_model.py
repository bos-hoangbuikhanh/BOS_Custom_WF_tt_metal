...
import ttnn
from models.bos_model.llama32.tt.common import PagedAttentionConfig, sample_host
from models.bos_model.llama32.tt.model import Transformer
from models.bos_model.llama32.tt.model_config import CheckpointType, DecodersPrecision, ModelArgs
...
def test_model_inference(
    ...
    if layers == 1:
        ...
        pcc = 0.94 if mode_accuracy else 0.81
