...
import ttnn
from models.bos_model.llama32.tt.common import PagedAttentionConfig, create_tt_model
from models.bos_model.llama32.tt.generator import Generator
...
@pytest.mark.parametrize(
    ...
    (
        128,
        1024,
    ),  # Board crashes for higher seq_len # FIXME
...
def test_model_inference(
    ...
    if (
        ...
        or model_args.base_model_name.startswith("Llama-3.2")
    ):
