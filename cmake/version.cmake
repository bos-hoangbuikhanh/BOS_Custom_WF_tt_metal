...
function(ParseGitDescribe)
    ...
    if(NOT "${tagname}" MATCHES "${tagRegex}")
        # [BOS-ARCH-011] If tag name cannot be parsed, forcibly set the tag version to v0.65.0
        message(WARNING "Cannot parse tag '${tagname}', forcibly setting tagname to v0.65.0")
        set(tagname "v0.65.0")
    endif()
    if(NOT "${tagname}" MATCHES "${tagRegex}")
